...
public class TelaLoginModal extends javax.swing.JDialog {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        MenuPrincipalAdm menuadm = new MenuPrincipalAdm();
        MenuPrincipalAgendamento menuagendamento = new MenuPrincipalAgendamento();
        MenuPrincipalAtendimento menuatendimento = new MenuPrincipalAtendimento();
                
        if(txtLogin.getText().equals("usuario1") && txtSenha.getText().equals("senha")) {
        ...
        else if (txtLogin.getText().equals("usuario2") && txtSenha.getText().equals("senha")){
            login = txtLogin.getText();
            senha = txtSenha.getText();
            ...
            menuagendamento.setVisible(true);

        }
        else if(txtLogin.getText().equals("usuario3") && txtSenha.getText().equals("senha")) {
            login = txtLogin.getText();
            senha = txtSenha.getText();
